...
public class application {
    ...
    /**
     * Displays all requests in reverse chronological order, i.e., newest to oldest.
     *
    ...
    /**
     * Identifies the user with the highest number of unique request types. If two or more users have the same number,
     * displays the user with the earliest or most recent request in the dataset based on the flag.
     *
     * @param map  the map of users and their requests
     * @param flag the flag to determine whether to use the earliest or most recent request in case of a tie
     */
    ...
    /**
     * Filters and displays all requests made by a specific user based on their User ID.
     *
     * @param map    the map of users and their requests
    ...
    /**
     * Identifies all requests of a specified type.
     *
     * @param map         the map of request types and their requests
     * @param requestType the request type to filter requests by
     */
    ...
    /**
     * Identifies all requests within a specified timestamp range.
     *
     * @param requests the list of requests to filter
     * @param after    the start timestamp of the range
     * @param before   the end timestamp of the range
     */
    ...
    /**
     * Identifies the user with the longest active span (i.e., the user with the longest time between their first and last request).
     * If two or more users have the same length span, displays the user with the latest request.
     *
     * @param map the map of users and their requests
     */
    ...
    /**
     * Deduplicates the new dataset to remove all requests appearing in both the original log and the new dataset.
     *
     * @param original    the original list of requests
     * @param newRequests the new list of requests
     * @return a deduplicated list of requests
     */
